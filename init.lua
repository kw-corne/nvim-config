...
require("lazy").setup({
...

	{
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>fo", builtin.live_grep, { desc = "[F]ind in [O]pen files by grep" })
...

	{
		...
		init = function()
			...
			vim.keymap.set("n", "<leader>tc", function()
				current_cmd = vim.fn.input("Command: ")
			end, { desc = "Set current [T]erminal [C]ommand" })
